========================================================================
    アプリケーション: ShimensokaStageMaker プロジェクトの概要
========================================================================

この ShimensokaStageMaker アプリケーションは、AppWizard により作成されました。  

このファイルには、ShimensokaStageMaker 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

ShimensokaStageMaker.vcxproj
...
ShimensokaStageMaker.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、ShimensokaStageMaker.pch 
